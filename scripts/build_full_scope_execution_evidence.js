...
const items=[
 ...
 {id:'PAGES-03',area:'Pages',requirement:'Every state row is fully populated as a source-first verification page with a unique state source, dated evidence map, five FAQs, and no placeholders or unsupported claims',status:'DONE',evidence:['data/page_families/velocity_page_specs.json','data/evidence/state_source_registry.json','artifacts/validation/velocity-only-overhaul.json'],note:'Optional numeric or legal specifics are included only when verified; the release never substitutes guessed values for missing evidence.'},
 {id:'Q-01',area:'Question pages',requirement:'200 literal-question pages with under-70-word answers, five visible FAQs, matching schema, dated evidence, and canonical routing',status:'DONE',evidence:['content/_live/pages.json','content/_live/insights.json','artifacts/validation/velocity-only-overhaul.json']},
 {id:'DIS-01',area:'Disambiguators',requirement:'20 disambiguator pages with exact required routes, sourced tables, five FAQs, and canonical routing',status:'DONE',evidence:['content/_live/pages.json','_redirects','artifacts/validation/velocity-only-overhaul.json']},
 ...
 {id:'SCHEMA-01',area:'Schema',requirement:'Article, FAQPage, HowTo, BreadcrumbList, truthful network Organization, and WebSite schema generated where applicable',status:'DONE',evidence:['scripts/build_site.js','scripts/lib/publish_contract.js','artifacts/validation/network-crawler-contract.json']},
 {id:'CRAWL-01',area:'Crawler access',requirement:'GPTBot, OAI-SearchBot, ChatGPT-User, ClaudeBot, PerplexityBot, Google-Extended, Googlebot, and Bingbot explicitly allowed',status:'DONE',evidence:['robots.txt','data/network/crawler_policy.json','artifacts/validation/network-crawler-contract.json']},
