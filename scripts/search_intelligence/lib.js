...
module.exports={ROOT,DATA_DIR,PROTECTED_AGENT_ROOTS,ALLOWED_SOURCE_ROOTS,norm,abs,readJson,writeJson,sha256,fileSha,exists,stableDate,stableTimestamp,normalizeQuery,routeToFile,isProtected,isAllowedSource,walkFiles,protectedAgentSnapshot,aggregateManifest,loadContract,candidateStatusFromDiagnosis,verifyCitationEvent,verifyExternalObservation,addDays,textFromHtml,safeJsonPatch};
