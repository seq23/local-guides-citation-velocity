...
def main():
    ...
    for r in rows:
        ...
        entry = {
            ...
            # could never restore the prior keyword-tool volume, while
            # keyword_difficulty -- which this block does not set -- survived.
            #
    ...
    doc["schema_version"] = doc.get("schema_version", "2.0")
