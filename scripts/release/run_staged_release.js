...
const SOURCE_DATE=process.env.SOURCE_DATE||readCurrentThrough()||'2026-06-19';
...
function readCurrentThrough(){try{return JSON.parse(fs.readFileSync(path.join(ROOT,'data/citation_velocity/runs.json'),'utf8')).current_through;}catch{return null;}}
