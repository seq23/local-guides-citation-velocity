...
const files=[
 'REPO_IDENTITY.md','_repo_update_contract.json','_repo_lifecycle_profile.json','_repo_validation_matrix.json','_validation_registry.json','_browser_suite_contract.json','_public_route_manifest.json','_baseline_packaging_contract.json','package.json','package-lock.json',
 ...
 'data/network/network_identity_registry.json','data/network/crawler_policy.json','data/seo/backlink_evidence_registry.json','data/seo/search_submission_registry.json','data/measurement/llm_query_panel.json',
 ...
 'scripts/build_site.js','scripts/lib/publish_contract.js','scripts/velocity_content_release.js','scripts/validation/run_validation_registry.js','scripts/validation/validate_validation_registry.js','scripts/validators/validate_velocity_only_overhaul.js','scripts/validators/validate_citation_velocity_master_plan.js','scripts/validators/validate_deterministic_build.js',
 ...
 'docs/architecture/ADR-2026-06-19-02-VELOCITY-ONLY.md','docs/overhaul/VELOCITY_ONLY_FULL_SCOPE_OVERHAUL.md','docs/runbooks/README.md','data/community/index_manifest.json','scripts/community/update_indexes.js','scripts/validators/validate_social_content_loop.js',
...
const data={
 ...
 release_critical_files:files.map(f=>({path:f,sha256:hash(f),size_bytes:fs.statSync(path.join(ROOT,f)).size})),
