...
const data={
 ...
 status:'LOCAL_GUIDES_100K_180_DAY_CITATION_FACTORY_STRUCTURALLY_CHECKED',
 generated_at:new Date().toISOString(),
 source_sha256:sourceSha,
 release_critical_files:critical,
 zip_checks:{integrity:'REOPEN_AND_TEST_FINAL_ARCHIVE',wrapper:'local-guides-citation-velocity-main',exclusions:['.git','node_modules','.env','.env.*','dist','.build','artifacts/validation/runtime','*.log','*.zip'],hashes:'FINAL_ARCHIVE_SHA256_SIDECAR'}
};
