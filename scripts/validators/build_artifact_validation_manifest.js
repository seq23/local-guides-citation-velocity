...
let files=[
 'README.md','REPO_IDENTITY.md','AGENTS.md','_repo_update_contract.json','_repo_lifecycle_profile.json','_repo_validation_matrix.json','_validation_registry.json','_browser_suite_contract.json','_public_route_manifest.json','_baseline_packaging_contract.json','package.json','package-lock.json',
