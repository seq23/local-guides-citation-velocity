...
Status: **PASS**
Workflows: 6 · Manual-ready: 6 · Scheduled: 1 · Push-triggered: 1
...
| velocity_content_release.yml | schedule:daily<br>workflow_dispatch | public signals<br>Velocity source queue<br>monitor ledgers | validated commit on main<br>release diagnostics | Source repair, word-count scoring, build, and validation must pass before commit and again after rebase. |
